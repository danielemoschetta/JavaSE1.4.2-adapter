 ...
 *
 * <p>The <code>List</code> interface places additional stipulations, beyond those
 ...
 *
 * <p>The <code>List</code> interface provides four methods for positional (indexed)
 ...
 * implementation.
 *
 * <p>The <code>List</code> interface provides a special iterator, called a
 ...
 *
 * <p>The <code>List</code> interface provides two methods to search for a specified
 * object.  From a performance standpoint, these methods should be used with
 * caution.  In many implementations they will perform costly linear
 * searches.
 *
 * <p>The <code>List</code> interface provides two methods to efficiently insert and
...
public interface HList extends HCollection {
	 ...
	 * {@literal (fromIndex < 0 || toIndex > size || fromIndex > toIndex)}.
	 */
